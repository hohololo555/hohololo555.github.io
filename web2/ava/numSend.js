...
function stringToBase32(inputStr){
    ...
    while (inputStr.length > 0) {
        ...
        let byte2 = -1;
        if (inputStr.length > 1) { // If there are more than one bytes
...
let numbers = ["4a639968fce0b0a6f48578ae3cf956499aac6c0f","9f2082f2e9bce0f07f474fec12151a1a9cc0af5b","525bcc3088b51c02b9296d87e8888a1bea0d6eda","82ad95ec5d032f65793282b6ce74aa4602e60abb"]



function pausecomp(secs){
    // its a bad implementation of the 
...
function numCheck(numinp){
    if (numinp === undefined) {
        throw "no input provided";
    } else if (numbers.includes(SHA1(numinp))){
...
function getGoing(){
	var j = document.getElementById('phone').value;
	numCheck(j);
}
